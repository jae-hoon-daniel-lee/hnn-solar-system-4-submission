...
from utils_data import import_mltsc_data
...
MODEL_NAME=f"mltsc-baseline-hnn({LAYERS})({HIDDEN_DIMS})"
MODEL_DIR="./checkpoints/multi-scale"
...
FIG_DIR=f"{TYPE_DIR}/multi-scale"
...
def prepare_all(hidden_dim=240, layers=3):
    ...
    train_loader, test_loader=import_mltsc_data(model_dir=MODEL_DIR, 
